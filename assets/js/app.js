...
function ShowForum(){
    ...
    console.log("showforum") /* aqui */
}

function CloseForum(){
    let MForum = document.getElementById("ModalForum")
    MForum.classList.remove("d-flex")
    console.log("CloseForum") /* aqui */
}
